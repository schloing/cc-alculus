...
typedef enum {
    ...
    TOK_RIGHT_PARENTH, TOK_LEFT_SQUARE, TOK_RIGHT_SQUARE, TOK_AMPERSAND,
    TOK_ADDITION, TOK_DIVISION, TOK_GREATER_THAN, TOK_LESS_THAN,
    TOK_HASHTAG, TOK_SUBTRACTION, TOK_EXCLAMATION, TOK_VERTICAL_BAR,
    ...
    TOK_DECREMENT, TOK_ADD_ASSIGN, TOK_SUBTRACT_ASSIGN, TOK_ASTERISK,
